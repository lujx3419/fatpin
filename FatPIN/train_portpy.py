...
def main():
    ...
    for episode in range(Episode):
        file_list = ['patient1.mat', 'patient2.mat', 'patient3.mat', 'patient4.mat', 'patient5.mat']  # 患者列表
        num_of_file = 0
        for file in file_list:
            ...
            print("Initialization completed, Patient No. {0}, Round No. {1} begins".format(num_of_file, episode+1))
